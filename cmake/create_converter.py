...
def generate_msgs(package, ec_msg_converter_filename):
    """
...
#            raise
    ...
    s = StringIO()
    s.write("// autogenerated by rtt_subsystem_ports/create_converter.py\n")
    s.write("// do not modify this file\n\n")
